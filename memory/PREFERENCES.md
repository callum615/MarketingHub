...
- **Meta connector**: Pipeboard Meta Ads MCP is decommissioned — Callum removed it as a vendor. Meta access is now via the native `mcp__claude_ai_Meta__*` connector (direct Meta integration, no third-party vendor cap). Ad account `1928354054506891` ("Galway Finance") confirmed ACTIVE/queryable. Never reach for Pipeboard again; ignore prior "no native Meta connector exists" notes as stale. (2026-07-25)
