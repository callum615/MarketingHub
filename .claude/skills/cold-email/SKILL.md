...
**Check for AU finance compliance guardrails:**
If `.claude/AU-finance-compliance.md` exists, read it before writing. Confirm and state the consent basis for the outreach (Spam Act 2003 requires consent or an existing business relationship exemption for commercial electronic messages) and avoid unsolicited-offer framing that could trigger anti-hawking restrictions on credit products.
