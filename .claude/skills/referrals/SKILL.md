...
**Check for AU finance compliance guardrails — read this before designing any incentive structure:**
If `.claude/AU-finance-compliance.md` exists, read it first. Mortgage brokers face a **conflicted remuneration ban** (2020 reforms) — volume-based or loan-value-tied commissions/benefits to referral partners (e.g. real estate agents, accountants) are likely prohibited. Do not design tiered, percentage-of-loan, or volume-based referral/affiliate incentives. Flag any referral structure explicitly for Purple Circle compliance sign-off before it's built, and default to non-monetary or flat, non-performance-tied arrangements where the business model allows.
