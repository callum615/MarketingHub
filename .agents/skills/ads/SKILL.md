...
If `.Codex/AU-finance-compliance.md` exists, read it before drafting any campaign copy, targeting, or claims. Apply its comparison-rate, prohibited-claims, and disclosure rules to every ad — this is a regulated credit business, not a generic SaaS/DTC product.
