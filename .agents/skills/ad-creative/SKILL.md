...
If `.Codex/AU-finance-compliance.md` exists, read it before generating any creative. Run the pre-send checklist there before delivering ad copy: no guaranteed-outcome claims, comparison rate + representative example when a rate is stated, standard credit disclosure line, and genuine (disclosed) testimonials only.
